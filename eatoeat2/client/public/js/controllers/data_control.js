...
// $cookieStore.put('s3cr3t_user_data', response.data[0]);
          ...
          //  $scope.cart_collection = $localStorage.cart_collection;
            ...
            if (len < 1) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if ($scope.cart_collection[i].food_id == item._id && $scope.cart_collection[i].order_date == $scope.dd.date) {
    ...
    $scope.attach_addr_id=function(addr_id,food_id){
     ...
     var addr_name="";
        ...
        var user_data= $cookieStore.get('s3cr3t_user_data');
                ...
                for(var i=0;i<$scope.checkout_cart_view.length;i++){
                    console.log('1');
                        if($scope.checkout_cart_view[i].food_id==food_id){
                                ...
                                $scope.checkout_cart_view[i].username =  user_data[0].username;
